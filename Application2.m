...
xlim([0 500])
title(ax2,'(a) $\phi_2$-optimality', 'Interpreter', 'latex', ...
        'FontSize', 20)
xlabel('$u_i$', 'Interpreter', 'latex', ...
        'FontSize', 20)
...
xlim([0 500])
title(ax3,'(a) $\phi_3$-optimality', 'Interpreter', 'latex', ...
        'FontSize', 20)
xlabel('$u_i$', 'Interpreter', 'latex', ...
        'FontSize', 15)
...
xlim([0 500])
title(ax4,'(a) $\phi_4$-optimality', 'Interpreter', 'latex', ...
        'FontSize', 20)
xlabel('$u_i$', 'Interpreter', 'latex', ...
        'FontSize', 15)
...
xlim([0 500])
title(ax5,'(d) Multi-objective optimality', 'Interpreter', 'latex', ...
        'FontSize', 15)
xlabel('$u_i$', 'Interpreter', 'latex', ...
        'FontSize', 15)
